...
<div id="searchpanel" class="panel-body search-panel">
    <div class="row row-height">
      <div class="col-height col-md-3">
            <label>{{ labels.usernames_label }}</label>
            <input type="text" v-model="localData.username" class="form-control input-md" maxlength="50" />
        </div>
        <div class="col-height col-md-3">
            <label>{{ labels.usertnames_label }}</label>
            <input type="text" v-model="localData.usertname" class="form-control input-md" maxlength="50" />
        </div>
        <div class="col-height col-md-3">
            <label>{{ labels.usertsurnames_label }}</label>
            <input type="text" v-model="localData.usertsurname" class="form-control input-md" maxlength="50" />
        </div>
...
const tableSettings = {
    ...
    columns: [
      {name: "username", type: "STRING", sorter: "username", label: "username_headerlabel" },
        {name: "usertname", type: "STRING", sorter: "usertname", label: "usertname_headerlabel" },
        {name: "usertsurname", type: "STRING", sorter: "usertsurname", label: "usertsurname_headerlabel" },
